...
Kubo now supports sharing the same TCP port (`4001` by default) by both [raw TCP](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#swarmtransportsnetworktcp) and [WebSockets](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#swarmtransportsnetworkwebsocket)  libp2p transports.
...
It is no longer necessary to manually add `/tcp/../ws` listeners to `Addresses.Swarm` when [`AutoTLS.Enabled`](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#autotlsenabled) is set to `true`. Kubo will detect if `/ws` listener is missing and add one on the same port as pre-existing TCP (e.g. `/tcp/4001`), removing the need for any extra configuration.
> [!TIP]
> Give it a try:
> ```console
...
Onboarding files and directories with `ipfs add --to-files` now requires non-empty names. due to this, The `--to-files` and `--wrap` options are now mutually exclusive ([#10612](https://github.com/stateless-minds/kubo/issues/10612)).
...
Now that Kubo supports [`pebble`](https://github.com/stateless-minds/kubo/blob/master/docs/datastores.md#pebbleds) as an _experimental_ datastore backend, it becomes very useful to expose some additional configuration options for how the blockservice/blockstore/datastore combo behaves.
...
As a reminder, details from all the options are explained in the [configuration documentation](https://github.com/stateless-minds/kubo/blob/master/docs/config.md).

We recommend users trying Pebble as a datastore backend to disable both blockstore bloom-filter and key caching layers and enable write through as a way to evaluate the raw performance of the underlying datastore, which includes its own bloom-filter and caching layers (default cache size is `8MiB` and can be configured in the [options](https://github.com/stateless-minds/kubo/blob/master/docs/datastores.md#pebbleds).

#### MFS stability with large number of writes

We have fixed a number of issues that were triggered by writing or copying many files onto an MFS folder: increased memory usage first, then CPU, disk usage, and eventually a deadlock on write operations. The details of the fixes can be read at [#10630](https://github.com/stateless-minds/kubo/pull/10630) and [#10623](https://github.com/stateless-minds/kubo/pull/10623). The result is that writing large amounts of files to an MFS folder should now be possible without major issues. It is possible, as before, to speed up the operations using the `ipfs files --flush=false <op> ...` flag, but it is recommended to switch to `ipfs files --flush=true <op> ...` regularly, or call `ipfs files flush` on the working directory regularly, as this will flush, clear the directory cache and speed up reads. 
...
- github.com/stateless-minds/kubo:
  - test: fix the socat tests after the ubuntu 24.04 upgrade (#10683) ([ipfs/kubo#10683](https://github.com/stateless-minds/kubo/pull/10683))
  - chore: 0.33.0-rc3
  - fix: quic-go v0.49.0 (#10673) ([ipfs/kubo#10673](https://github.com/stateless-minds/kubo/pull/10673))
  - Upgrade to Boxo v0.27.2 (#10672) ([ipfs/kubo#10672](https://github.com/stateless-minds/kubo/pull/10672))
  - chore: 0.33.0-rc2
  - Upgrade to Boxo v0.27.1 (#10671) ([ipfs/kubo#10671](https://github.com/stateless-minds/kubo/pull/10671))
  - fix(autotls): renewal and AutoTLS.ShortAddrs (#10669) ([ipfs/kubo#10669](https://github.com/stateless-minds/kubo/pull/10669))
  - update changelog for boxo and go-libp2p (#10668) ([ipfs/kubo#10668](https://github.com/stateless-minds/kubo/pull/10668))
  - Upgrade to Boxo v0.27.0 (#10665) ([ipfs/kubo#10665](https://github.com/stateless-minds/kubo/pull/10665))
  - update dependencies (#10664) ([ipfs/kubo#10664](https://github.com/stateless-minds/kubo/pull/10664))
  - fix(dns): update default DNSLink resolvers (#10655) ([ipfs/kubo#10655](https://github.com/stateless-minds/kubo/pull/10655))
  - chore: p2p-forge v0.2.2 + go-libp2p-kad-dht v0.28.2 (#10663) ([ipfs/kubo#10663](https://github.com/stateless-minds/kubo/pull/10663))
  - fix(cli): support HTTPS in ipfs --api (#10659) ([ipfs/kubo#10659](https://github.com/stateless-minds/kubo/pull/10659))
  - chore: fix typos and comment formatting (#10653) ([ipfs/kubo#10653](https://github.com/stateless-minds/kubo/pull/10653))
  - fix/gateway: escape directory redirect url (#10649) ([ipfs/kubo#10649](https://github.com/stateless-minds/kubo/pull/10649))
  - Add example of setting array to config command help
  - collection of typo fixes (#10647) ([ipfs/kubo#10647](https://github.com/stateless-minds/kubo/pull/10647))
  - chore: 0.33.0-rc1
  - fix: ipfs-webui v4.4.2 (#10635) ([ipfs/kubo#10635](https://github.com/stateless-minds/kubo/pull/10635))
  - feat(libp2p): shared TCP listeners and AutoTLS.AutoWSS (#10565) ([ipfs/kubo#10565](https://github.com/stateless-minds/kubo/pull/10565))
  - feat(flatfs): default to sync=false (#10632) ([ipfs/kubo#10632](https://github.com/stateless-minds/kubo/pull/10632))
  - Minor spelling and wording changes (#10634) ([ipfs/kubo#10634](https://github.com/stateless-minds/kubo/pull/10634))
  - docs: clarify Swarm.ResourceMgr.MaxMemory (#10622) ([ipfs/kubo#10622](https://github.com/stateless-minds/kubo/pull/10622))
  - feat: expose BlockKeyCacheSize and enable WriteThrough datastore options (#10614) ([ipfs/kubo#10614](https://github.com/stateless-minds/kubo/pull/10614))
  - cmd/files: flush parent folders (#10630) ([ipfs/kubo#10630](https://github.com/stateless-minds/kubo/pull/10630))
  - Upgrade to Boxo v0.26.0 (#10631) ([ipfs/kubo#10631](https://github.com/stateless-minds/kubo/pull/10631))
  - [skip changelog] pinmfs: mitigate slow mfs writes when it triggers (#10623) ([ipfs/kubo#10623](https://github.com/stateless-minds/kubo/pull/10623))
  - chore: use errors.New to replace fmt.Errorf with no parameters (#10617) ([ipfs/kubo#10617](https://github.com/stateless-minds/kubo/pull/10617))
  - chore: boxo v0.25.0 (#10619) ([ipfs/kubo#10619](https://github.com/stateless-minds/kubo/pull/10619))
  - fix(cmds/add): disallow --wrap with --to-files (#10612) ([ipfs/kubo#10612](https://github.com/stateless-minds/kubo/pull/10612))
  - refactor(cmds): do not return errors embedded in result type (#10527) ([ipfs/kubo#10527](https://github.com/stateless-minds/kubo/pull/10527))
  - fix: ipfs-webui v4.4.1 (#10608) ([ipfs/kubo#10608](https://github.com/stateless-minds/kubo/pull/10608))
  - chore: fix broken url in comment (#10606) ([ipfs/kubo#10606](https://github.com/stateless-minds/kubo/pull/10606))
  - refactor(rcmgr): use default libp2p rcmgr metrics (#9947) ([ipfs/kubo#9947](https://github.com/stateless-minds/kubo/pull/9947))
  - docs(changelog/v0.33): bitswap reprovide changes (#10604) ([ipfs/kubo#10604](https://github.com/stateless-minds/kubo/pull/10604))
  - tests(cli/harness): use unused Verbose flag to pipe daemon outputs (#10601) ([ipfs/kubo#10601](https://github.com/stateless-minds/kubo/pull/10601))
  - chore: p2p-forge/client v0.1.0 (#10605) ([ipfs/kubo#10605](https://github.com/stateless-minds/kubo/pull/10605))
  - fix: go-libp2p v0.37.2 (#10603) ([ipfs/kubo#10603](https://github.com/stateless-minds/kubo/pull/10603))
  - docs: typos (#10602) ([ipfs/kubo#10602](https://github.com/stateless-minds/kubo/pull/10602))
  - tests/cli: fix flapping tests (#10600) ([ipfs/kubo#10600](https://github.com/stateless-minds/kubo/pull/10600))
  - Update to boxo with refactored providerQueryManager. (#10595) ([ipfs/kubo#10595](https://github.com/stateless-minds/kubo/pull/10595))
  - fix some typos in docs (#10598) ([ipfs/kubo#10598](https://github.com/stateless-minds/kubo/pull/10598))
  - feat(bootstrap): add JS-based va1.bootstrap.libp2p.io (#10575) ([ipfs/kubo#10575](https://github.com/stateless-minds/kubo/pull/10575))
  - fix: increase provider sample size (#10589) ([ipfs/kubo#10589](https://github.com/stateless-minds/kubo/pull/10589))
  - Typos Update config.md (#10591) ([ipfs/kubo#10591](https://github.com/stateless-minds/kubo/pull/10591))
  - refactor: update to boxo without goprocess (#10567) ([ipfs/kubo#10567](https://github.com/stateless-minds/kubo/pull/10567))
  - fix: go-libp2p-kad-dht v0.28.1 (#10581) ([ipfs/kubo#10581](https://github.com/stateless-minds/kubo/pull/10581))
  - docs: update RELEASE_CHECKLIST.md (#10564) ([ipfs/kubo#10564](https://github.com/stateless-minds/kubo/pull/10564))
  - Merge release v0.32.0 ([ipfs/kubo#10579](https://github.com/stateless-minds/kubo/pull/10579))
...
- github.com/stateless-minds/kubo:
  - chore: v0.33.1
  - fix: boxo v0.27.4 (#10692) ([ipfs/kubo#10692](https://github.com/stateless-minds/kubo/pull/10692))
  - docs: add webrtc-direct fixes to 0.33 release changelog (#10688) ([ipfs/kubo#10688](https://github.com/stateless-minds/kubo/pull/10688))
  - fix: config help (#10686) ([ipfs/kubo#10686](https://github.com/stateless-minds/kubo/pull/10686))
