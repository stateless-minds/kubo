...
For more information about our A/B tests, see [kubo#10825](https://github.com/stateless-minds/kubo/pull/10825).
...
For a description of the configuration items, see the documentation of [`Internal.Bitswap.BroadcastControl`](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#internalbitswapbroadcastcontrol).
...
This connection manager option controls how often connections are swept and potentially terminated. See the [ConnMgr documentation](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#swarmconnmgrsilenceperiod).
