...
Starting now, any publicly dialable Kubo node with a `/tcp` listener that remains online for at least one hour will receive a TLS certificate through the [`AutoTLS`](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#autotls) feature.
...
For more details, check out the [`AutoTLS` configuration documentation](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#autotls) or dive deeper with [AutoTLS libp2p blog post](https://blog.libp2p.io/autotls/).
...
- `ipfs config` is now validating json fields ([#10679](https://github.com/stateless-minds/kubo/pull/10679)).
- Deprecated the `bitswap reprovide` command. Make sure to switch to modern `routing reprovide`. ([#10677](https://github.com/stateless-minds/kubo/pull/10677))
- The `stats reprovide` command now shows additional stats for [`Routing.AcceleratedDHTClient`](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#routingaccelerateddhtclient), indicating the last and next `reprovide` times. ([#10677](https://github.com/stateless-minds/kubo/pull/10677))
...
> - **As a Gateway Operator:** Override publisher TTLs for faster updates using configurations like [`Ipns.MaxCacheTTL`](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#ipnsmaxcachettl) in Kubo or [`RAINBOW_IPNS_MAX_CACHE_TTL`](https://github.com/ipfs/rainbow/blob/main/docs/environment-variables.md#rainbow_ipns_max_cache_ttl) in [Rainbow](https://github.com/ipfs/rainbow/).

#### `IPFS_LOG_LEVEL` deprecated

The variable has been deprecated. Please use [`GOLOG_LOG_LEVEL`](https://github.com/stateless-minds/kubo/blob/master/docs/environment-variables.md#golog_log_level) instead for configuring logging levels.
...
The reprovide process can be quite slow. In default settings, the reprovide process will start reading CIDs that belong to the pinset. During this operation, starvation can occur for other operations that need pinset access (see https://github.com/stateless-minds/kubo/issues/10596).
...
Use [`Reprovider.Strategy`](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#reproviderstrategy) to balance announcement prioritization, speed, and memory utilization.
...
- github.com/stateless-minds/kubo:
  ...
  - feat: ipfs-webui v4.6 (#10756) ([ipfs/kubo#10756](https://github.com/stateless-minds/kubo/pull/10756))
  - docs(readme): update min. requirements + cleanup (#10750) ([ipfs/kubo#10750](https://github.com/stateless-minds/kubo/pull/10750))
  - Upgrade to Boxo v0.29.1 (#10755) ([ipfs/kubo#10755](https://github.com/stateless-minds/kubo/pull/10755))
  - Nonfunctional (#10753) ([ipfs/kubo#10753](https://github.com/stateless-minds/kubo/pull/10753))
  - Update docs/changelogs/v0.34.md
  - provider: buffer pin providers.
  - chore: 0.34.0-rc1
  - fix(mfs): basic UnixFS sanity checks in `files cp` (#10701) ([ipfs/kubo#10701](https://github.com/stateless-minds/kubo/pull/10701))
  - Upgrade to Boxo v0.29.0 (#10742) ([ipfs/kubo#10742](https://github.com/stateless-minds/kubo/pull/10742))
  - use go-datastore without go-process (#10736) ([ipfs/kubo#10736](https://github.com/stateless-minds/kubo/pull/10736))
  - docs(config): add security considerations for rpc (#10739) ([ipfs/kubo#10739](https://github.com/stateless-minds/kubo/pull/10739))
  - chore: update go-libp2p to v0.41.0 (#10733) ([ipfs/kubo#10733](https://github.com/stateless-minds/kubo/pull/10733))
  - feat: ipfs-webui v4.5.0 (#10735) ([ipfs/kubo#10735](https://github.com/stateless-minds/kubo/pull/10735))
  - Create FUNDING.json (#10734) ([ipfs/kubo#10734](https://github.com/stateless-minds/kubo/pull/10734))
  - feat(AutoTLS): enabled by default with 1h RegistrationDelay (#10724) ([ipfs/kubo#10724](https://github.com/stateless-minds/kubo/pull/10724))
  - Upgrade to Boxo v0.28.0 (#10725) ([ipfs/kubo#10725](https://github.com/stateless-minds/kubo/pull/10725))
  - Upgrade to go1.24 (#10726) ([ipfs/kubo#10726](https://github.com/stateless-minds/kubo/pull/10726))
  - Replace go-random with random-data from go-test package (#10731) ([ipfs/kubo#10731](https://github.com/stateless-minds/kubo/pull/10731))
  - Update to new go-test (#10729) ([ipfs/kubo#10729](https://github.com/stateless-minds/kubo/pull/10729))
  - Update go-test and use new random-files generator (#10728) ([ipfs/kubo#10728](https://github.com/stateless-minds/kubo/pull/10728))
  - docs(readme): update docker section (#10716) ([ipfs/kubo#10716](https://github.com/stateless-minds/kubo/pull/10716))
  - Update go-ds-badger to v0.3.1 (#10722) ([ipfs/kubo#10722](https://github.com/stateless-minds/kubo/pull/10722))
  - Update pebble db to latest format by default (#10720) ([ipfs/kubo#10720](https://github.com/stateless-minds/kubo/pull/10720))
  - fix: switch away from IPFS_LOG_LEVEL (#10694) ([ipfs/kubo#10694](https://github.com/stateless-minds/kubo/pull/10694))
  - Merge release v0.33.2 ([ipfs/kubo#10713](https://github.com/stateless-minds/kubo/pull/10713))
  - Remove unused TimeParts struct (#10708) ([ipfs/kubo#10708](https://github.com/stateless-minds/kubo/pull/10708))
  - fix(rpc): restore and deprecate `bitswap reprovide` (#10699) ([ipfs/kubo#10699](https://github.com/stateless-minds/kubo/pull/10699))
  - docs(release): update RELEASE_CHECKLIST.md after v0.33.1 (#10697) ([ipfs/kubo#10697](https://github.com/stateless-minds/kubo/pull/10697))
  - docs: update min requirements (#10687) ([ipfs/kubo#10687](https://github.com/stateless-minds/kubo/pull/10687))
  - Merge release v0.33.1 ([ipfs/kubo#10698](https://github.com/stateless-minds/kubo/pull/10698))
  - fix: boxo v0.27.4 (#10692) ([ipfs/kubo#10692](https://github.com/stateless-minds/kubo/pull/10692))
  - fix: Issue #9364 JSON config validation (#10679) ([ipfs/kubo#10679](https://github.com/stateless-minds/kubo/pull/10679))
  - docs: RELEASE_CHECKLIST.md update for 0.33 (#10674) ([ipfs/kubo#10674](https://github.com/stateless-minds/kubo/pull/10674))
  - feat: Better self-service commands for DHT providing (#10677) ([ipfs/kubo#10677](https://github.com/stateless-minds/kubo/pull/10677))
  ...
  - feat: Add CI for Spell Checking (#10637) ([ipfs/kubo#10637](https://github.com/stateless-minds/kubo/pull/10637))
  - Merge release v0.33.0 ([ipfs/kubo#10684](https://github.com/stateless-minds/kubo/pull/10684))
  ...
  - docs(readme): add unofficial Fedora COPR (#10660) ([ipfs/kubo#10660](https://github.com/stateless-minds/kubo/pull/10660))
  ...
  - Add example of setting array to config command help ([ipfs/kubo#10650](https://github.com/stateless-minds/kubo/pull/10650))
