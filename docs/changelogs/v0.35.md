...
- github.com/stateless-minds/kubo:
  ...
  - fix: go-libp2p-kad-dht v0.33.1 (#10814) ([ipfs/kubo#10814](https://github.com/stateless-minds/kubo/pull/10814))
  - fix: p2p-forge v0.5.1 ignoring /p2p-circuit (#10813) ([ipfs/kubo#10813](https://github.com/stateless-minds/kubo/pull/10813))
  - chore(version): 0.35.0-rc2
  - fix(fuse): ipns error handling and friendly errors (#10807) ([ipfs/kubo#10807](https://github.com/stateless-minds/kubo/pull/10807))
  - fix(config): wire up `Provider.Enabled` flag (#10804) ([ipfs/kubo#10804](https://github.com/stateless-minds/kubo/pull/10804))
  - docs(changelog): go-libp2p-kad-dht
  - chore(version): 0.35.0-rc1
  - feat: IPFS_WAIT_REPO_LOCK (#10797) ([ipfs/kubo#10797](https://github.com/stateless-minds/kubo/pull/10797))
  - logging: upgrade to go-log/v2 v2.6.0 (#10798) ([ipfs/kubo#10798](https://github.com/stateless-minds/kubo/pull/10798))
  - chore: ensure /mfs is present in docker
  - feat(fuse): Expose MFS as FUSE mount point (#10781) ([ipfs/kubo#10781](https://github.com/stateless-minds/kubo/pull/10781))
  - feat: opt-in http retrieval client (#10772) ([ipfs/kubo#10772](https://github.com/stateless-minds/kubo/pull/10772))
  - Update go-libp2p-pubsub to v0.13.1 (#10795) ([ipfs/kubo#10795](https://github.com/stateless-minds/kubo/pull/10795))
  - feat(config): ability to disable Bitswap fully or just server (#10782) ([ipfs/kubo#10782](https://github.com/stateless-minds/kubo/pull/10782))
  - refactor: make datastore metrics opt-in (#10788) ([ipfs/kubo#10788](https://github.com/stateless-minds/kubo/pull/10788))
  - feat(pebble): support pinning `FormatMajorVersion` (#10789) ([ipfs/kubo#10789](https://github.com/stateless-minds/kubo/pull/10789))
  - feat: `Provider.WorkerCount` and `stats reprovide` (#10779) ([ipfs/kubo#10779](https://github.com/stateless-minds/kubo/pull/10779))
  - Upgrade to Boxo v0.30.0 (#10794) ([ipfs/kubo#10794](https://github.com/stateless-minds/kubo/pull/10794))
  - docs: use latest fuse package (#10791) ([ipfs/kubo#10791](https://github.com/stateless-minds/kubo/pull/10791))
  - remove duplicate words (#10790) ([ipfs/kubo#10790](https://github.com/stateless-minds/kubo/pull/10790))
  - feat(config): `ipfs add` and `Import` options for controlling UnixFS DAG Width (#10774) ([ipfs/kubo#10774](https://github.com/stateless-minds/kubo/pull/10774))
  - feat(config): expose ProviderSearchMaxResults (#10773) ([ipfs/kubo#10773](https://github.com/stateless-minds/kubo/pull/10773))
  - feat: ipfs-webui v4.7.0 (#10780) ([ipfs/kubo#10780](https://github.com/stateless-minds/kubo/pull/10780))
  - feat: partial DAG provides with Reprovider.Strategy=mfs|pinned+mfs (#10754) ([ipfs/kubo#10754](https://github.com/stateless-minds/kubo/pull/10754))
  - chore: update url
  - docs: known issues with file/urlstores (#10768) ([ipfs/kubo#10768](https://github.com/stateless-minds/kubo/pull/10768))
  - fix: Add IPFS & IPNS path details to error (re. #10762) (#10770) ([ipfs/kubo#10770](https://github.com/stateless-minds/kubo/pull/10770))
  - docs: Fix typo in v0.34 changelog (#10771) ([ipfs/kubo#10771](https://github.com/stateless-minds/kubo/pull/10771))
  - Support WithIgnoreProviders() in provider query manager ([ipfs/kubo#10765](https://github.com/stateless-minds/kubo/pull/10765))
  - Merge release v0.34.1 ([ipfs/kubo#10766](https://github.com/stateless-minds/kubo/pull/10766))
  - fix: reprovides warning (#10761) ([ipfs/kubo#10761](https://github.com/stateless-minds/kubo/pull/10761))
  - Merge release v0.34.0 ([ipfs/kubo#10759](https://github.com/stateless-minds/kubo/pull/10759))
  ...
  - provider: buffer pin providers ([ipfs/kubo#10746](https://github.com/stateless-minds/kubo/pull/10746))
  - chore: 0.35.0-dev
