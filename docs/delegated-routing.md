...
- Related Issues:
  - https://github.com/stateless-minds/kubo/issues/9188
  - https://github.com/stateless-minds/kubo/issues/9079
  - https://github.com/stateless-minds/kubo/pull/9877
...
Kubo 0.14 introduced experimental support for [delegated routing](https://github.com/stateless-minds/kubo/pull/8997),
which then got changed and standardized as [Routing V1 HTTP API](https://specs.ipfs.tech/routing/http-routing-v1/).

Kubo 0.23.0 release added support for [self-hosting Routing V1 HTTP API server](https://github.com/stateless-minds/kubo/blob/master/docs/changelogs/v0.23.md#self-hosting-routingv1-endpoint-for-delegated-routing-needs).


> [!TIP]
> Kubo 0.35 added support for [`Routing.DelegatedRouters`](https://github.com/stateless-minds/kubo/blob/master/docs/config.md#routingdelegatedrouters).
>
...
- https://github.com/stateless-minds/kubo/issues/9079#issuecomment-1211288268
- https://github.com/stateless-minds/kubo/issues/9157
- https://github.com/stateless-minds/kubo/issues/9079#issuecomment-1205000253
